...
Printrun. If not, see <http://www.gnu.org/licenses/>."""
    ...
    def _add_settings(self, size):
        ...
        self.settings._add(SpinSetting("printer_progress_update_interval", 0, 0, 120, _("Printer progress update interval"), _("Interval in which pronterface sends the progress to the printer if enabled, in seconds"), "Printer"))
